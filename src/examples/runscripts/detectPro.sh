...
OUTFILE=$(echo detectPro $WORM_ID)
...
sed -e 's/detectPro\/extra/detectPro\/instance\/'$WORM_ID'/g' instance/cfg/global.cfg > /root/detectPro/instance/$WORM_ID/cfg/global.cfg
